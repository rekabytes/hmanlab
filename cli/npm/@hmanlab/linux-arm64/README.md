...
Prebuilt [hmanlab](https://github.com/hmanlab/hmanlab) binary for **linux-arm64** (musl, statically-linked).
...
MIT licensed — see `LICENSE` in this package, or the [repo](https://github.com/hmanlab/hmanlab).
